<%-- 
    Document   : LineasInvestigacion
    Created on : 19/06/2018, 05:51:23 PM
    Author     : JhanxD
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ page import="java.util.* , Control.Linea_InvestigacionCotroller"%>
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center">LINEAS DE INVESTIGACION REGISTRADAS</h1>
        <div class="container">
            <form  id="BuscaLinea">
                                            <div class="row">
                                                <div class="col-4">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="form1" method="POST" enctype="multipart/form-data" action="Lineas_InvestigacionCotroller" id="frmnuevo">
                    ...
                    <table class="table">
                        ...
                        <tr class="modal-footer">
                            ...
                            <td><input type="button" class="btn btn-primary btn-sm"  id="guardar" aria-label="Small" title="Guardar Linea" value="Agregar"></td>
                        </tr>
                    </table>
                </form>
            </div>
...
<div class="modal fade" id="modaleditar" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Modificar Linea de Investigacion</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form name="form2" method="POST" enctype="multipart/form-data" action="Lineas_InvestigacionCotroller" id="frmeditable">
                        ...
                        <tbody id="cuerpo">
                            <div class="modal-body">
                                            <div class="form-group col-12">
                                                <label for="txtNombreFacultadER">Escuela</label>
                                            ...
                                            <div class="form-group col-12">
                                                <label for="txtNombreAbreviadoER">Area</label>
                                            ...
                                            <div class="form-group col-12">
                                                <label for="txtNombreER">Linea</label>
...
<script type="text/javascript" src="js/apps/LineasInvestigacion.js"></script>
